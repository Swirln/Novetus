%MgmxzgmsPB3UcMLj3wYOkSOtbJsnF8I/Q2PguW7Zp3gKE5GIm1qUzyTGgBs16GXCrbZXVB9/EYfxZseJ7qCfooUsxcWpC5Jqvff2QD1KjoP3CgvH1QpYjoSKE5ZRem3JHWoeGXtMJiubYX2ApRkqv2EFmFkfNFkXv6Tp7EP1YQk=%%10%
...
BackgroundUp.Size = UDim2.new(0, 600, 0.025, 1)
BackgroundUp.Position = UDim2.new(0.5, -300, 0, 0)
...
for i = 0, 9 do
	...
	if i == 0 then
		slotFrame.Position = UDim2.new(0.9, 54,0,0)
	else
