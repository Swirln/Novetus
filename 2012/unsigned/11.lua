%MgmxzgmsPB3UcMLj3wYOkSOtbJsnF8I/Q2PguW7Zp3gKE5GIm1qUzyTGgBs16GXCrbZXVB9/EYfxZseJ7qCfooUsxcWpC5Jqvff2QD1KjoP3CgvH1QpYjoSKE5ZRem3JHWoeGXtMJiubYX2ApRkqv2EFmFkfNFkXv6Tp7EP1YQk=%%11%
...
local hideBackpack = function()
	...
	backpack:TweenSizeAndPosition(UDim2.new(0, 600,0, 0), UDim2.new(0.5, -300, 1, -85), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, guiTweenSpeed, true,
		function()
...
function showBackpack()
	...
	backpack.Visible = true
	backpackButton.Selected = true	
	backpack:TweenSizeAndPosition(UDim2.new(0, 600, 0, 400), UDim2.new(0.5, -300, 1, -485), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, guiTweenSpeed, true)
	delay(guiTweenSpeed,function()
		backpack.Tabs.Visible = false
