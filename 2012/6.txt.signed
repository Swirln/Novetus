%MgmxzgmsPB3UcMLj3wYOkSOtbJsnF8I/Q2PguW7Zp3gKE5GIm1qUzyTGgBs16GXCrbZXVB9/EYfxZseJ7qCfooUsxcWpC5Jqvff2QD1KjoP3CgvH1QpYjoSKE5ZRem3JHWoeGXtMJiubYX2ApRkqv2EFmFkfNFkXv6Tp7EP1YQk=%%6%
local mainFrame
local choices = {}
local lastChoice
local choiceMap = {}
...
function initialize(parent)
	...
	imageLabel.Position = UDim2.new(1,-9,0.3, 0)
   ...
   imageLabel.RobloxLocked = true
	...
	area.Size = UDim2.new(1,-32,1,-32)
   area.RobloxLocked = true
	area.Parent = mainFrame
...
function presentDialogChoices(talkingPart, dialogChoices)
   ...
   local yPosition = 0
	...
	for n, obj in pairs(sortedDialogChoices) do
		if pos <= #choices then
			local height = math.ceil(string.len(obj.UserDialog)/16)*24 + 4
